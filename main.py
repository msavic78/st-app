...
if not st.session_state['logged_in']:
    ...
    if st.session_state['user_type'] == "Viewer":
        ...
        from data_editing import display_and_edit_dataframe
        ...
        if left_df is not None and right_df is not None:
            ...
            if left_df_styled is not None:
                ...
                display_and_edit_dataframe(left_df, "left", left_file_path)
            ...
            if right_df_styled is not None:
                ...
                display_and_edit_dataframe(right_df, "right", right_file_path)
        else:
